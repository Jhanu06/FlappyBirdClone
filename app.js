...
function create() {
  ...
  this.physics.add.overlap(bird, road, () => handleGameOver(this), null, this);
  this.physics.add.collider(bird, road);

  this.physics.add.overlap(bird, topColumns, () => handleGameOver(this), null, this);
  this.physics.add.overlap(bird, bottomColumns, () => handleGameOver(this), null, this);
...
// Handle game over and restart the game
function handleGameOver(scene) {
  ...
  // Restart the scene when space is pressed
